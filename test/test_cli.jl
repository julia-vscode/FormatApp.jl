@testitem "flag compatibility matrix" setup=[CLIHelper] begin
    run_cli, MESSY, CLEAN = CLIHelper.run_cli, CLIHelper.MESSY, CLIHelper.CLEAN
...
@testitem "check and write modes" setup=[CLIHelper] begin
    run_cli, MESSY = CLIHelper.run_cli, CLIHelper.MESSY
...
@testitem "unified diff output" setup=[CLIHelper] begin
...
@testitem "exclusion is skipped, not an error" setup=[CLIHelper] begin
    run_cli, MESSY, CLEAN = CLIHelper.run_cli, CLIHelper.MESSY, CLIHelper.CLEAN
...
@testitem "stdin" setup=[CLIHelper] begin
    run_cli, MESSY = CLIHelper.run_cli, CLIHelper.MESSY
